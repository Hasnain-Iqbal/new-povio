const PovioSolutionsData = {
    ...
    HRService: [
        {
            id: '1',
            HRtitles : 'Decentralization',
            HRdescription: 'The PoVio project is built on a decentralized platform, which allows digital influencers to connect directly with their audience and monetize their content without intermediaries.',
            Hicon: 'panel',
            rclass : 'pr_70',
            iclass: 'icon_one',
        },
        {
            id: '2',
            HRtitles : 'NFTs for ownership & control',
            HRdescription: 'By using NFTs as a form of digital ownership, the PoVio project allows digital influencers to control their content and monetize their works in a new and innovative way.',
            Hicon: 'layout-grid2',
            rclass : 'pl_50 pr_20',
            iclass: 'icon_two',
        },
        {
            id: '3',
            HRtitles : 'Fair compensation',
            HRdescription: 'The PoVio project eliminates the need for intermediaries, allowing digital influencers to receive a fairer compensation for their work and have complete control over their revenue.',
            Hicon: 'fullscreen',
            rclass : 'pl_70',
            iclass: 'icon_three',
        },
        {
            id: '4',
            HRtitles : 'Increased reach and visibility',
            HRdescription: 'The PoVio project provides a decentralized platform for digital influencers to reach and engage with their audience, allowing them to bypass the limitations imposed by centralized platforms.',
            Hicon: 'vector',
            rclass : 'pr_70',
            iclass: 'icon_four',
        },
        {
            id: '5',
            HRtitles : 'Freedom from censorship',
            HRdescription: 'The decentralized nature of the PoVio project helps to ensure that digital influencers have the freedom to express themselves and reach their audience without fear of censorship or removal of their content.',
            Hicon: 'cloud-down',
            rclass : 'pl_50 pr_20',
            iclass: 'icon_five',
        },
...
export default PovioSolutionsData;